...
typedef struct
{
  ...
  ControlItem present_position_right = {140, RAM, 4, READ};
    // 리프트 모터를 위한 항목 추가
    ControlItem present_position_lift = {144, RAM, 4, READ};
    ControlItem present_velocity_lift = {148, RAM, 4, READ};
    ControlItem present_current_lift = {152, RAM, 4, READ};
  ...
  // 리프트 모터 제어 항목
  ControlItem cmd_velocity_lift = {182, RAM, 4, READ_WRITE};
  ControlItem profile_acceleration_lift = {186, RAM, 4, READ_WRITE};
} ControlTable;
